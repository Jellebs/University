...
def get_dataloaders_mnist(
    ...
    if train_transforms is None:
        train_transforms = transforms.Compose([transforms.ToTensor()]) # transforms.ToTensor()

    if test_transforms is None:
        test_transforms = transforms.Compose([transforms.ToTensor()]) # transforms.ToTensor()

    train_dataset = datasets.MNIST(
        root="./", train=True, transform=train_transforms, download=True
    )
    valid_dataset = datasets.MNIST(root="./", train=True, transform=test_transforms)

    test_dataset = datasets.MNIST(root="./", train=False, transform=test_transforms)
