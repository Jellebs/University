...
profilPath = "../Profiler/"
referencePath = "../Øvelser/Data/"

PurgeAir1 = ImportFil(referencePath + "Ref_500middel.pulse.csv");
PurgeRef = ImportFil(referencePath + 'Si_500middel.pulse.csv');
PurgeAir = ImportFil(referencePath + "Ref_500middel.pulse.csv");
% filename = '16_26'; % Define the base filename (without extensions)
PurgeSam = ImportFil(profilPath + "Proeve1_Scan6.pulse.csv"); % Use the variable for importing
