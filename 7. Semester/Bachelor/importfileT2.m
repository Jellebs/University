function PurgeRef = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   PURGEREF = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   PURGEREF = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   PurgeRef = importfile('PurgeRef.pulse.csv', 2, 2003);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/02/21 09:49:36
